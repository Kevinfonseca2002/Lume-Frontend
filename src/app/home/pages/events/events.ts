  ...
  ngOnInit(){
    setTimeout(() => {
      this.events=[
        ...
        {imagen:"../../../../assets/images/Foodies.jpg", titulo: "Foodies", fecha: "Oct 25 7:00pm", descripcion: "Únete a nosotros para una experiencia culinaria única en la que exploraremos sabores locales e internacionales. ¡No te lo pierdas!"},
        {imagen:"../../../../assets/images/Travellers.jpg", titulo: "Travellers", fecha: "Nov 30 6:00am", descripcion: "Comparte tus experiencias de viaje y descubre nuevos destinos con otros entusiastas de los viajes. ¡Inspírate y planifica tu próxima aventura!"},
